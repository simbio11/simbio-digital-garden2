...
```
Agent(
  prompt="Read C:/Users/cmksc/quartz/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/cmksc/quartz/.claude/gsd-core/templates/VALIDATION.md`
