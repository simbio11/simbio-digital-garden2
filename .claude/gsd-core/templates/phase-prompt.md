...
<!-- For checkpoint task examples and patterns, see @C:/Users/cmksc/quartz/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/Users/cmksc/quartz/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Users/cmksc/quartz/.claude/gsd-core/templates/user-setup.md` for full schema and examples
