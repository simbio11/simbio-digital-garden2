...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/cmksc/quartz/.claude
                  → checks C:/Users/cmksc/quartz/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/cmksc/quartz/.claude/gsd-core
                  → writes to C:/Users/cmksc/quartz/.claude/gsd-core/hooks/
