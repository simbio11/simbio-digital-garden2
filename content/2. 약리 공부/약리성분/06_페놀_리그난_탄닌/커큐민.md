...
- **복합제 성분으로서의 '음성 근거'(2026-09-24 리뷰 2번)**: Osteoarthritis and Cartilage 2026;34(10):1515-1524, [PMID: 42331134](https://pubmed.ncbi.nlm.nih.gov/42331134/) — 커큐민 500 mg/일을 포함한 경구 복합제(보스웰리아·소나무껍질·MSM·피페린 병용)가 무릎 OA 12주에서 **위약 대비 차이 없음**(군간차 0.16 mm, 95% CI −6.81~7.12, 임상적 유의 기준 18 mm 배제).
- **해석의 층위 구분(핵심 교훈)**: 커큐민 단독의 골관절염 메타분석(본 노트 7번 출처)과 **복합제 시험 결과는 서로 다른 정보**다 — 임상에서는 ① 제형(생체이용률 개선형) ② 단독 vs 복합 ③ 대상 관절·표현형을 구분해 설명해야 한다 → [[피페린]] · [[보스웰리아]]
- **기전-임상 괴리**: 항염 기전([[NF-κB]]·COX-2·5-LOX 억제)이 존재해도 임상 결과가 따라오지 않는다는 대표 사례다 → [[NF-κB]]
- **진료실 문장**: "커큐민은 항염 기전 연구가 많은 성분이지만, 여러 성분을 섞은 제품에서는 위약과 차이가 없었습니다. 제형·복용법에 따라 흡수가 크게 달라지므로 제품 근거를 따로 확인해야 합니다."
- 관련: [[퇴행성 슬관절염]] · [[메틸설포닐메탄]] · [[OARSI 2019 가이드라인]] · [[2026-09-24_통합의학약리학_심층리뷰]] 2번
