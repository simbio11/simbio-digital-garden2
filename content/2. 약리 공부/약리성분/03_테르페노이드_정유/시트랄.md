...
![[시트랄_화학구조식.png|320]]
> [그림 1: 시트랄 2D 화학 분자 구조식 (출처: 위키미디어 공용 · NCI CACTVS 구조 데이터)]
...
| :--- | :--- | :--- | :--- | :--- |
| [[필징가]] (蓽澄茄) | 녹나무과(Lauraceae) / *Litsea cubeba* (또는 후추과 *Piper cubeba*) | 건조한 성숙 열매 | *Litsea cubeba* 정유 기준 78.7~87.4%(중국 8개 산지 실측, PMID 미색인·DOI 확인) — 기존 필징가 노트의 60~75% 표기는 산지·기원식물(후추과 *Piper cubeba* 가능성 포함)에 따른 차이로 추정되며 재검증 권고 | 脾·胃·腎·膀胱經, 온중산한·행기지통·건비소식·온신조양 |
...
5. **Zhao YM, et al. (2012)** — "Chemical Composition of Essential Oils of Litsea cubeba Harvested from Its Distribution Areas in China". *Molecules*, 17(6), 7057–7065. DOI: [10.3390/molecules17067057](https://doi.org/10.3390/molecules17067057). (PubMed 미색인 확인, DOI로 대체)
   - **[연구 요약]**: 중국 8개 산지에서 채취한 *Litsea cubeba* 정유를 GC-MS 분석한 결과, 네랄+제라니알(시트랄) 함량이 산지별 78.7%(윈난성)~87.4%(구이저우성)로 확인됨.
6. **PubChem CID 638011 (Citral)**; **CAS 5392-40-5**. National Center for Biotechnology Information.
   - **[화학 데이터베이스]**: 분자식·CAS 번호 등 공인 화학 데이터.

> ⚠️ 내용 검토 필요: §2의 지표 함량은 *Litsea cubeba* 기준 실측 문헌(78.7~87.4%)을 새로 확인해 반영했으나(2026-09-13), 필징가 노트가 명시한 60~75%와는 산지·기원식물 차이로 추정되는 괴리가 있어 원전(후추과 *Piper cubeba* 기준 수치일 가능성) 재검증이 필요합니다. §4의 정량적 ADME 데이터, §7의 CYP450 상호작용 데이터는 이번에도 확인된 문헌이 없어 데이터 없음으로 유지합니다.

<!-- 보관 태그(1회용·링크오류, 필요시 복원): 필징가 -->
