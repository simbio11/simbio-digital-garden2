...
> - <font color="#fa7e7e">⚠️ 독성·생체이용률 한계 & 상호작용: 고농도 세포·동물 연구에서 심장·간 독성이 보고된 바 있고 트리테르펜 사포닌 특유의 낮은 경구 생체이용률을 가져, 단일 성분 고농도 투여 결과를 전탕액(煎湯液) 복용의 저농도 노출과 동일시할 수 없습니다.</font>
...
```mermaid
graph TD
    Compound["🔬 사이코사포닌 D 세포/간세포 유입"] --> Target1["1) ER 스트레스 매개 TLR4/MyD88/NF-κB/NLRP3 경로 억제"]
    Compound --> Target2["2) 산화적 스트레스(ROS) 억제"]
    Compound --> Target3["3) MAPK(ERK/p38/JNK) 과인산화 차단"]
    Target1 --> Outcome1["✨ 담즙정체성 간손상 완화"]
    Target2 --> Outcome2["✨ CCl4 유발 급성 간손상 완화"]
    Target3 --> Outcome3["✨ 간세포·상피세포 자멸사 억제"]
```
...
<font color="#fa7e7e">⚠️ 내용 검토 필요: 위 두 연구 모두 동물·세포 모델 수준이며, 인체 대상 임상시험(RCT) 근거는 이번 검색 범위 내에서 확인되지 않았습니다.</font>
