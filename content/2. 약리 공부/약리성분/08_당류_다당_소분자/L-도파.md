...
> - <font color="#fa7e7e">⚠️ 독성·생체이용률 한계 & 상호작용: 단독 투여 시 중추 도달률 1% 미만(말초 AADC에 의한 조기 전환)이라 카르비도파·벤세라지드 등 말초 DDC 억제제와 반드시 병용해야 하며, 고단백 식사·비선택적 MAO 억제제와 상호작용 주의.</font>
...
```mermaid
graph TD
    LDOPA["🔬 L-도파 경구 투여"] --> LAT1["LAT1 수송체로 BBB 통과"]
    LAT1 --> AADC["선조체 AADC/DDC 탈탄산"]
    AADC --> DA["도파민(Dopamine) 생성"]
    DA --> D1["D1 수용체(직접경로) → 운동 촉진"]
    DA --> D2["D2 수용체(간접경로) → 운동억제 해제"]
```
