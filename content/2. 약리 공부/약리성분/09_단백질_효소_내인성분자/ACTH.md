...
> - <font color="#fa7e7e">⚠️ 독성·생체이용률 한계 & 상호작용: 혈중 반감기 약 6~7분으로 극히 짧고, 외인성 글루코코르티코이드 장기 투여 시 음성 되먹임으로 ACTH 분비가 억제되어 부신 위축·부신기능부전 위험이 발생.</font>
...
```mermaid
graph TD
    Stress["스트레스 & 일주기 신호"] --> Hypo["시상하부 [[CRH]] 분비"]
    Hypo --> Pituitary["뇌하수체 전엽 POMC 절단 → ACTH 분비"]
    Pituitary --> MC2R["부신피질 속상대 [[MC2R]] 결합 → Gs → cAMP"]
    MC2R --> PKA["PKA 활성화"]
    PKA --> StAR["StAR 단백질(콜레스테롤 미토콘드리아 이동) + CYP11A1"]
    StAR --> Cortisol["[[코르티솔]] 합성·분비"]
    Cortisol -- "음성 되먹임" --> Hypo
    Cortisol -- "음성 되먹임" --> Pituitary
```
...
<!-- 보관 태그(1회용·링크오류, 필요시 복원): 펩타이드호르몬, 스트레스반응 -->
