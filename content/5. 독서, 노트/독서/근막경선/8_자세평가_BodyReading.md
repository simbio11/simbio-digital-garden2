...
```mermaid
flowchart TD
    A["1단계: 지지면 & 발목 평가\n(족저 아치, 거골하관절 회내/회외)"] --> B["2단계: 무릎 & 골반 정렬\n(전방/후방경사, 외측 편위, 회전)"]
    B --> C["3단계: 흉곽 & 견갑대\n(후만, 침하, 전방경사, 익상견갑)"]
    C --> D["4단계: 두경부 & 악관절\n(전방두부자세, 턱관절 편위)"]
    D --> E["5단계: 3차원 근막경선 통합\n(주동 손상 경선 도출 & 치료 설계)"]
```
...
| [[5_상지경선_Arm_Lines]] | **수삼음경 & 수삼양경** | • **SFAL**: 수궐음심포경 / 수소음심경<br>• **DFAL**: 수태음폐경<br>• **SBAL**: 수양명대장경 / 수소양삼초경<br>• **DBAL**: 수태양소장경 | 중부, 척택, 극천, 내관, 곡지, 합곡, 천종, 후계 |
