...
> - 근감소증은 단순 노화뿐 아니라 `[[골다공증]]`(Osteo-sarcopenia), `[[비만]]`(Sarcopenic obesity), `[[노쇠]]`(Frailty), `[[Cachexia]](악액질)`와 밀접하게 교차 연결되어 사망률과 낙상·골절 위험을 급증시킨다.
...
- **신체 구성 성분과 근육량**:
  ...
  - 제지방량에서 골염류량(Bone mineral content)을 제외한 연부조직을 연부제지방량(Lean soft tissue mass)이라 하며, 이 중 팔과 다리의 연부제지방량을 **사지골격근량(Appendicular Lean Soft Tissue, ALST 또는 Appendicular Skeletal Muscle Mass, ASM)** 이라고 부른다.
  - ALST는 전신 골격근량(Total-body skeletal muscle mass)과 매우 높은 상관관계($r > 0.95$)를 나타내므로 임상 및 연구에서 [[근감소증]] 측정의 핵심 대리 지표로 사용된다.

> ![[Sarcopenia_Ch01_p6_Fig1.png|300]]
...
- **질병 분류의 역사적 전환점**:
  ...
  - 대한민국은 2021년 제8차 한국표준질병사인분류(KCD-8) 개정에서 근감소증에 **`M62.5`** 코드를 신설 부여하였고, 골격근량 측정 의료비용이 인정비급여로 산출되면서 임상적 제도화가 확립되었다.
...
> ![[Sarcopenia_Ch01_p9_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p10_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p13_Fig1.png|300]]
> **그림 1-6. 근감소증이 미치는 임상적 양상.** 일상생활 능력 저하, 균형 장애, 대사증후군, [[인슐린]] 저항성, 삶의 질 악화, 사망 위험 증가를 나타낸다.

> ![[Sarcopenia_Ch01_p14_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p16_Fig1.png|300]]
...
#### 2) EWGSOP2 개정안 (2018년)
- 패러다임 전환: **근력(Muscle strength)을 근감소증의 최우선 핵심 지표로 격상**.
- **진단 단계**:
...
> ![[Sarcopenia_Ch01_p17_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p18_Fig1.png|300]]
> **그림 1-11. Asian Working Group for Sarcopenia (AWGS)의 [[근감소증]] 진단 알고리즘 (2014년).** 보행속도 저하(<0.8 m/s) 또는 악력 저하(남 <26 kg, 여 <18 kg) 중 하나가 존재하면서 근육량 감소가 확인될 때 근감소증으로 진단.
...
> ![[Sarcopenia_Ch01_p19_Fig1.png|300]]
...
- **한국 여성 [[근감소증]] 빈도**:
  ...
  - 근육량과 근력을 모두 적용한 임상적 근감소증의 유병률은 65세 이상에서 약 **7.6%** (남성 9.6%, 여성 7.7%) 수준이다.

> ![[Sarcopenia_Ch01_p20_Fig1.png|300]]
...
- **근력 및 신체수행능력 평가**:
  ...
  - **[[5회 의자 일어서기 검사]] (Chair stand test)**: **$\ge 10$초** (AWGS 기준보다 엄격)
...
> ![[Sarcopenia_Ch01_p22_Fig1.png|300]]
...
근감소증의 조기 진단 및 치료 반응 모니터링을 위해 다양한 혈청 생화학 표지자가 연구되고 있다.

> ![[Sarcopenia_Ch01_p23_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p24_Fig1.png|300]]
...
> ![[Sarcopenia_Ch01_p26_Fig1.png|300]]
> **그림 1-18. Dysmobility syndrome: Osteo-sarcopenic obesity.** [[골다공증]], [[근감소증]], 비만이 상호 상승작용을 일으켜 운동성 소실 및 낙상·골절을 유발하는 병태생리 도식.
...
> ![[Sarcopenia_Ch01_p30_Fig1.png|300]]
...
- **[[속근]] 트로포닌 활성제 (Fast skeletal troponin activator)**: Tirasemtiv, CK-2127107(Reldesemtiv) — 칼슘에 대한 트로포닌 복합체 감수성을 증폭시켜 신경 자극 대비 근력 증강.
- **미토콘드리아 기능 강화제**: Elamipretide (Bendavia) — 미토콘드리아 내막 카디오리핀을 보호하여 [[ATP]] 생성 촉진.

> ![[Sarcopenia_Ch01_p32_Fig1.png|300]]
...
## 14. 결론
- 근감소증은 단순한 노화 현상이 아니라 장애, 골절, 대사질환, 사망을 초래하는 독립된 질병이다.
...
> ![[Sarcopenia_Ch02_p37_Fig1.png|300]]
> **그림 2-1. 앞팔 운동을 일으키는 기본적인 근육 및 그림 2-2. 뼈대근육 구조.** 굴곡근과 신전근의 협조 작용(상완이두근과 삼두근) 및 근육바깥막-근육다발-근육섬유-근원섬유-근원섬유마디로 이어지는 뼈대근육의 계층적 구성.
...
> ![[Sarcopenia_Ch02_p38_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p40_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p41_Fig1.png|300]]
> **그림 2-5. 니코틴아세틸콜린수용체 구조.** 5개의 막관통 소단위체로 구성된 오량체 구조 및 2개의 아세틸콜린 결합 부위.

> ![[Sarcopenia_Ch02_p42_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p44_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p45_Fig1.png|300]]
...
- **막계통의 구성**:
  ...
  - **근세포질그물(Sarcoplasmic Reticulum, SR)**: 세포질 내 칼슘을 저장하고 방출하는 소포체 그물망. T세관 양쪽에 팽대된 **종말수조(Terminal cisternae)** 를 형성.
  - **트라이아드 (Triad, 세조합)**: 1개의 T세관과 양측의 2개 종말수조가 이루는 특수 접합 구조로 흥분-수축 연결의 핵심 구조물.

> ![[Sarcopenia_Ch02_p47_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p48_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p50_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p52_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p54_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p55_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p57_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p59_Fig1.png|300]]
...
> ![[Sarcopenia_Ch02_p61_Fig1.png|300]]
> **그림 2-19. 자극빈도에 따른 뼈대근육 수축 형태.**
> - **(A) 단일수축 (Twitch)**: 단일 활동전위에 의한 1회성 미세 수축.
> - **(B) 가중 (Summation)**: 첫 번째 수축이 이완되기 전 연속 자극이 전달되어 세포질 칼슘이 누적되면서 장력이 가중됨.
