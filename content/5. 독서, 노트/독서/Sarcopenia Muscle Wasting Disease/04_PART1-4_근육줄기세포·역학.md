...
> - **[[근감소증]] 역학적 유병률**: 진단 기준 및 대상군에 따라 다양하나, 전 세계 129개 연구(27.4만 명) 메타분석상 통합 유병률은 **16%**(EWGSOP 22%, AWGS 15%, IWGS 14%, FNIH 11%, EWGSOP2 10%)이며, 60세 이상 지역사회 노인에서는 **10%**(EWGSOP2 5% ~ IWGS 17%)로 보고된다. 한국노인노쇠코호트([[KFACS]], 70~84세)에서는 AWGS 2019 기준 남성 **26.8%**, 여성 **18.8%**이며, 중증 근감소증은 남성 **8.9%**, 여성 **4.7%**이다. 65~69세(5%) 대비 85세 이상(20% 이상)에서 급증하며, [[당뇨병]](18%), 제2형 당뇨(6.3~47.1%), 간경변(25~70%), 투석 환자(4~68%) 등 만성질환군에서 유병률이 현저히 높다.
...
- **리소좀 기능 저하의 병태생리**:
  ...
  - 유비퀴틴-프로테아좀 시스템(UPS)이 주로 짧은 반감기의 개별 단백질을 분해하는 반면, 리소좀은 거대 단백질 복합체 및 손상된 세포 소기관(미토파지 Mitophagy, 소포체포식 ER-phagy)을 처리한다. 리소좀 결손은 독성 단백질 응집체를 축적시키고 염증성 [[사이토카인]] 분비를 자극하여 [[근감소증]] 가속화한다.

> ![[Sarcopenia_Ch08_p130_Fig1.png|540]]
...
> ![[Sarcopenia_Ch08_p134_Fig1.png|540]]
...
> ![[Sarcopenia_Ch08_p138_Fig1.png|540]]
...
> ![[Sarcopenia_Ch08_p142_Fig1.png|540]]
> **그림 8-3. [[근감소증]] 원리 및 신체기능 평가.** 노화 및 위성세포 기능 부전에 의해 골격근량과 근력이 손실되는 [[근감소증]](Sarcopenia)의 임상적 발현. 의자 일어서기 검사(Chair Stand Test), 균형 검사(Balance Test), 보행 속도 검사(Gait Speed Test), 악력 검사(Hand Grip Test)의 기능 저하와 직결된다.
...
- **전 세계 추정 유병률**: 진단 기준과 평가 도구에 따라 차이가 존재하나, 일반적으로 **전 세계 60세 이상 노인 인구의 10% ~ 16%**가 [[근감소증]] 이환된 것으로 추산된다.
...
[[근감소증]] 유병률 추정치는 사용된 합의 진단 기준(Consensus criteria), 근육량 측정 방식(DXA vs. BIA), 평가 항목 조합에 따라 상당한 편차를 보인다.
...
> ![[Sarcopenia_Ch09_p149_Fig1.png|540]]
...
> ![[Sarcopenia_Ch09_p150_Fig1.png|540]]
...
추적 관찰 코호트 연구들은 지역사회 노인 인구에서 매년 상당한 비율로 [[근감소증]] 신규 발병(Incident cases)함을 실증한다.
...
- **글로벌 리더십 이니셔티브(GLIS, Global Leadership Initiative in Sarcopenia, 2024)**:
  - [[근감소증]] 불가역적인 일방통행성 퇴행성 질환이 아니라, **"잠재적으로 가역적인 질병(Potentially Reversible Disease)"**으로 개념화되었다.
...
> ![[Sarcopenia_Ch09_p153_Fig1.png|540]]
...
- 60세 이상 노인 4,395명(평균 67세) 대상 평균 3.29년 추적(총 10,778회 관찰) 분석 (AWGS 2019 기준):
  - 기저 시점 **가능성 [[근감소증]](Possible sarcopenia)** 노인 중:
    ...
    - 6.7%는 확진 근감소증으로 악화.
    - 8.5%는 사망.
  - 연령, 성별, BMI, 신체기능, 흡연, [[고혈압]] 및 [[당뇨병]] 양방향 전이를 결정하는 유의한 인자임. 조기 스크리닝과 맞춤 운동·영양 중재의 결정적 중요성을 뒷받침한다.
...
[[근감소증]] 단순한 생리학적 노화 현상이 아니라 생존율을 위협하고 막대한 의료비 부담을 유발하는 치명적인 질환이다.

> ![[Sarcopenia_Ch09_p155_Fig1.png|540]]
...
- 60세 이상 노인 52,838명 대상 36편 통합 분석 (Yeung SSY et al., JCSM 2019):
  ...
  - [[골다공증]] [[근감소증]] 동반된 **골근감소증([[Osteosarcopenia]])** 환자에서 고관절 골절 등 치명적 골절 위험이 최고조에 달함.
...
- **InCHIANTI 연구 (이탈리아, 55개월 추적)**:
  - 교란 변수 보정 후, [[근감소증]] **신체 장애 OR 3.15** (95% CI: 1.41-7.05), **입원 HR 1.57** (1.03-2.41), **사망률 HR 1.88** (0.91-3.91)과 유의하게 연관됨.
...
<!-- 보관 태그(1회용·링크오류, 필요시 복원): 근감소증, muscle_stem_cell, MuSC, satellite_cell, PAX7, muscle_regeneration, 근육위축, muscle_atrophy, 역학, epidemiology, 유병률, prevalence, 발생률, incidence, 이행률, transition_rate, 가역성, reversibility, KFACS, 노인노쇠 -->
