...
graph TD
    ...
    H -->|1,25-OH2-D 상승| J[육아종성 질환: 사코이도시스, 결핵 대식세포 1-alpha-hydroxylase 또는 림프종]
    H -->|모두 정상/저하, SPEP/UPEP 양성| K[다발골수종 Multiple Myeloma 또는 골전이]
    H -->|약물력 확인| L[비타민 D 중독, 티아지드 이뇨제, 우유-알칼리 증후군]
```
