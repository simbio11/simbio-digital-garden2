...
```mermaid
graph LR
    subgraph 여아 사춘기 진행 단계
        A1[1. 유방 발아 Thelarche, B2<br>사춘기 첫 신체 징후, 8-13세] --> A2[2. 음모 출현 Pubarche, PH2<br>부신 안드로겐 Adrenarche 작용]
    ...
    subgraph 남아 사춘기 진행 단계
        ...
        B3 --> B4[4. 성장 급성장 Peak Height Velocity<br>연간 10 cm 성장, Tanner 4]
        B4 --> B5[5. 사정 Spermarche 및 변성기]
    end
```
