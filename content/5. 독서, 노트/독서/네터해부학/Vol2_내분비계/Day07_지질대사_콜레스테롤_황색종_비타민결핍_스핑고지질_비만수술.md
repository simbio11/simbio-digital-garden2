...
```mermaid
graph LR
    A[간 및 소장] -->|ApoA-I 분비| B[미성숙 원반형 Discoidal HDL]
    C[말초 조직 / 거품세포 Foam Cells] -->|ABCA1 수송체| D[유리 콜레스테롤 FC 방출]
    B -->|FC 수용| E[FC 장착 HDL]
...
```mermaid
graph TD
    subgraph 루와이 위우회술 RYGB
        A1[상부 소위낭 30mL 형성] -->|제한 작용| A2[식사량 격감]
        A3[음식물이 십이지장 우회하여 회장으로 직행] -->|영양소 조기 노출| A4[소장 L세포 극단적 자극]
    ...
    subgraph 위소매절제술 Sleeve Gastrectomy
        ...
        B3 --> B4[순환 공복 호르몬 그렐린 급락]
        B4 --> B5[식욕 및 배고픔 감각 소실]
    end
```
