...
```mermaid
graph LR
    subgraph Berg Levels 액와 림프절
        L1[Level I: 소흉근 외측연 외측<br>Lateral to Pectoralis Minor<br>- 외측 액와정맥군, 견갑하군, 전방 흉근군 4~6개]
        L2[Level II: 소흉근 심부/후방<br>Posterior/Deep to Pectoralis Minor<br>- 중심군 Central, 로터 근간 림프절 Rotter's nodes]
        L3[Level III: 소흉근 내측연 내측/상방<br>Medial/Superior to Pectoralis Minor<br>- 정점/쇄골하군 Subclavicular/Apical]
    end
    L1 --> L2 --> L3 --> SC[쇄골상 림프절 Supraclavicular / 림프본간 유입]
```
...
```mermaid
graph TD
    subgraph 1. 유즙 생성 Lactogenesis
        Suck_PRL[유두 흡철 자극 / 도파민 억제] --> PitAnt[뇌하수체 전엽 Anterior Pituitary]
        PitAnt -->|프로락틴 Prolactin 펄스 분비| Acinar[선포 입방/원주상피세포]
        Acinar -->|카제인, 유당, 지질 합성 및 분비| MilkStorage[선포 내강 모유 저장]
    end
    subgraph 2. 유즙 사출 반사 Let-Down Reflex
        Nipple_Sens[유두 기계수용체 자극 T4 신경] --> SpinalCord[척수 상행 신경로]
        SpinalCord --> Hypothal[시상하부 / 뇌하수체 후엽]
        Hypothal -->|옥시토신 Oxytocin 방출| Myoepithel[선포 주위 근상피세포 Myoepithelial cells]
        Myoepithel -->|강력한 평활근성 동시 수축| Expel[유관 압착 및 유관동 분출]
    end
```
