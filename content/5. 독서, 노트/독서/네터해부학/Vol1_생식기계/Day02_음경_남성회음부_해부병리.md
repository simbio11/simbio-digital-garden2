...
```mermaid
graph LR
 InternalIliac[내장골동맥 Internal Iliac A.] --> AntDiv[전분지 Anterior Div.]
 AntDiv --> IntPudendal[내음부동맥 Internal Pudendal A.]
 IntPudendal --> Alcock[음부신경관 Alcock Canal]
 Alcock --> InfRectal[하직장동맥 Inf. Rectal A.]
 Alcock --> PerinealArt[회음동맥 Perineal A. -> 후음낭동맥]
 Alcock --> BulbArt[망울요도동맥 Artery of Bulb]
 Alcock --> UrethralArt[요도동맥 Urethral A. -> 귀두까지 관류]
 Alcock --> DeepArt[해면체동맥 Cavernosal A. -> 나선동맥 -> 발기 유도]
 Alcock --> DorsalArt[음경등동맥 Dorsal A. -> 백막 관통 문합/귀두]
```
...
```mermaid
graph TD
 Stim[성적 자극 / 시각·촉각·중추] --> NANC[해면체신경 NANC 말단 & 혈관내피]
 NANC --> NO[산화질소 NO 방출]
 NO --> sGC[가용성 구아닐릴 고리화효소 sGC 활성화]
 sGC --> cGMP[GTP -> cGMP 합성 증가]
 cGMP --> PKG[단백질 인산화효소 G 활성화 -> K+ 채널 개방]
 PKG --> CaDrop[세포질 Ca2+ 급감 & 소포체 격리]
 CaDrop --> Relax[소주 및 나선동맥 평활근 이완]
