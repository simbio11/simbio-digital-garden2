...
```mermaid
graph TD
  Cervix[자궁경부 점액농성 감염] -->|점막 표면 상행| Endometrium[자궁내막염 Endometritis]
  Endometrium -->|난관 개구부 침입| Endosalpinx[급성 난관염 Acute Salpingitis]
  Endosalpinx --> Edema[점막 부종 및 화농성 삼출액 분비]
  Edema --> FimbrialClosure[난관채 안쪽 반전 및 복강 개구부 폐쇄]
  FimbrialClosure --> Pyosalpinx[고름 저류: 증류기형 난관축농증 Pyosalpinx]
  Pyosalpinx -->|내용물 무균 액화| Hydrosalpinx[장액 저류: 난관수종 Hydrosalpinx]
  Pyosalpinx -->|배란 난포/황체 침투| TOA[난관난소농양 Tubo-Ovarian Abscess]
```
