...
graph TD
    ...
    5AR --> DHT[DHT]
    DHT --> ExternalMale[외생식기 남성화: 음경·음낭·전립선]

    XX[46,XX 염색체] --> NoSRY[SRY 부재]
    NoSRY --> WNT4[WNT4 / RSPO1 / DAX1 / FOXL2 활성화 - 능동적 항-고환 경로]
    WNT4 --> OvaryDiff[난소 분화]
    OvaryDiff --> NoAMH[AMH 부재: 뮐러관 보존 -> 난관·자궁·상부 질]
    OvaryDiff --> NoAndrogen[안드로겐 부재: 볼프관 퇴행 & 외생식기 여성화]
```
...
```mermaid
graph LR
    Chol[콜레스테롤] -->|CYP11A1 / Desmolase| Preg[Pregnenolone]
    Preg --> Prog[Progesterone]
    Preg -->|CYP17A1| DHEA[DHEA]
