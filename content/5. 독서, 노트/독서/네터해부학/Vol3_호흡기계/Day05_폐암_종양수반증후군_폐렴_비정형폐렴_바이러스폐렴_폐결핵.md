...
section: "Section 4: Diseases and Pathology (Part 2: Neoplasms & Pulmonary Infections)"
day: 5
section_pages: "pp. 158-212"
total_plates: 22
...
tags:
  ...
  - 폐결핵
aliases:
  - "Netter Respiratory Day 05"
  - "Netter 폐암 및 폐감염질환"
  - "Thoracic Oncology & Infectious Diseases Master Note"
status: completed
created: 2026-09-18
title: Day05_폐암_종양수반증후군_폐렴_비정형폐렴_바이러스폐렴_폐결핵
date: 2026-09-21
...
```mermaid
graph TD
    A[원발성 폐암 Primary Lung Cancer] --> B[비소세포폐암 NSCLC: 85%]
    A --> C[소세포폐암 SCLC: 15%]
    B --> D[선암종 Adenocarcinoma: 40-50%<br/>말초 호발, 비흡연/여성, TTF-1/Napsin A+, EGFR/ALK 타깃]
    B --> E[편평세포암종 Squamous Cell: 25-30%<br/>중심 기관지 호발, 흡연 직결, p40/p63+, 각화진주, 공동 형성]
    B --> F[대세포암종 Large Cell: 5-10%<br/>미분화 고도 악성, 진단 배제적]
    C --> G[신경내분비 암종 Neuroendocrine<br/>흡연 직결, Synaptophysin/CD56+, 소금-후추 염색질, 조기 혈행 전이]
```
...
```mermaid
graph TD
    A[폐첨부 종양 Pancoast Tumor] --> B[상완신경총 하신경간 C8-T2 침범]
    A --> C[경부 교감신경 연쇄 / 성상신경절 침범]
    A --> D[제1-2 늑골 및 쇄골하 동정맥 침범]
    B --> E[어깨 및 제4-5수지 방사통, 수부 근위축]
    C --> F[호너 증후군 Horner's Triad:<br/>1. 안검하수 Ptosis<br/>2. 축동 Miosis<br/>3. 동측 안면 무한증 Anhidrosis]
    D --> G[국소 흉벽 골통증 및 상지 정맥 울혈]
```
...
```mermaid
graph LR
    A[1. 울혈기 Congestion<br/>1-2일: 혈관 확장 충혈,<br/>장액성 부종액, 세균 증식] --> B[2. 적색간변기 Red Hepatization<br/>2-4일: 적혈구/호중구/피브린 유출,<br/>폐가 간처럼 단단해짐]
    B --> C[3. 회색간변기 Gray Hepatization<br/>4-6일: 적혈구 용해, 피브린 침착,<br/>모세혈관 압박으로 건조/회백색]
    C --> D[4. 용해기 Resolution<br/>8-10일: 대식세포 효소 분해,<br/>삼출물 액화 흡수, 정상 폐 복원]
```
...
```mermaid
graph TD
    A[결핵균 호흡기 흡입] --> B[폐포 대식세포 탐식 & 리소좀 융합 억제]
    B --> C[대식세포 내 결핵균 증식]
    C --> D[수지상세포 IL-12 분비: Th1 세포 분화]
    D --> E[Th1 세포: 인터페론 감마 IFN-γ & TNF-α 분비]
    E --> F[대식세포 활성화: NO 생성 및 살균능 획득]
    E --> G[상피양 세포 Epithelioid & 랑게르한스 거대세포 융합]
    F & G --> H[외곽 림프구/섬유아세포 띠 형성]
    H --> I[중심부 무산소 건괴 괴사 Caseous Granuloma 형성: 균 봉인]
```
...
```mermaid
graph TD
    subgraph Initial_Phase["초기 강화기: 2개월 (4제 병용)"]
        A1[Isoniazid H]
        A2[Rifampin R]
        A3[Pyrazinamide Z]
        A4[Ethambutol E]
        A1 & A2 & A3 & A4 --> B[급속 분열균 조기 살균 & 다제내성 발현 방지]
    end
    subgraph Continuation_Phase["유지 치료기: 4개월 (2제 병용)"]
        C1[Isoniazid H]
        C2[Rifampin R]
        C1 & C2 --> D[조직 내 잔여 휴면균 멸균 & 재발 방지]
    end
    B --> Continuation_Phase
    D --> E[총 6개월 표준 치료 완료: 완치]
```
