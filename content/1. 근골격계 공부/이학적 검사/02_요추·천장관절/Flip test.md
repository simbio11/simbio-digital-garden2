...
| **이명 및 관련 징후** | 좌위 라세그 검사(Seated Lasègue Test), 주의분산 하지직거상 검사(Distraction SLR), Seated Straight Leg Raise Test / SSLR, 플립 징후(Flip sign), Waddell 주의분산 검사(Waddell Distraction Test) |
...
* 좌위(Sitting)는 이미 고관절이 90° 굴곡되어 있어 대퇴 후면의 [[좌골신경]]이 팽팽한 기초 긴장(Pre-tension) 상태를 유지하며, 무릎을 90° 굴곡에서 0° 신전으로 펴 올리면 종아리 및 발목으로 주행하는 경골신경과 총비골신경이 말초로 강하게 당겨집니다.
...
* 무릎이 펴지는 순간 신경근에 가해지는 견인 장력을 완화하기 위해 환자는 무의식적으로 고관절의 굴곡 각도를 90°에서 45°~30°로 급격히 줄여야만 하며, 체중을 뒤로 실어 양손으로 침상 바닥을 짚습니다.
...
* 환자에게 "다리를 들어 올려 허리 신경 검사를 하겠다"고 미리 알리지 않습니다. 대신 "발목 관절을 확인하겠습니다", "무릎 힘줄 반사를 체크하겠습니다", 또는 "신발이나 양말을 벗기겠습니다"라며 시선을 발목이나 무릎 쪽으로 유도합니다.
...
* **각도 기준**: 진성 신경근병증에서는 무릎이 45°~70° 이상 펴지면서 환자가 심한 하지 방사통과 함께 상체를 뒤로 급격히 젖히고 두 손으로 침상을 짚으며 저항합니다. 반면 비기질적 환자는 앙와위 [[SLR test]]에서 20~30°만 올려도 비명을 지르던 환자가, 좌위에서 주의가 분산된 채 무릎이 90° 수평(고관절 90° + 슬관절 0°)으로 완전히 펴져도 몸통이 꼿꼿이 유지되고 별다른 고통을 표현하지 않습니다.
...
* **비기질적 징후 양성 (Waddell's Distraction Sign (+))**:
  ...
  * 좌위 무릎 90° 완전 신전은 고관절 90° 굴곡 상태이므로 앙와위 90° 거상과 역학적으로 동일함에도 아무런 신경 증상을 호소하지 않음.
* **슬괵근 단축과의 감별 (False Positive Distinction)**:
  * 방사통 없이 오금 뒤쪽만 팽팽하게 당긴다면 슬괵근 단축. 족관절 배굴(Bragard 기동)을 추가했을 때 발끝 방사통이 나타나지 않으면 음성.
  * 발목을 저측굴곡(Plantarflexion)시키면 즉시 편해지고, 배굴(Dorsiflexion) 시 신경 증상이 악화되는지를 통해 감별합니다.
...
| [[Seated Laseque test]] (동일 검사의 이명) | 좌위 (Sitting) | 앉은 자세에서 종아리를 들어 올릴 때 몸통 후방 쏠림 관찰 | 플립 검사와 동일한 좌위 하지직거상 검사 |
...
* **사용자 원문 필기 2 (100% 완벽 보존 / 좌위 라세그 검사 원문)**:
