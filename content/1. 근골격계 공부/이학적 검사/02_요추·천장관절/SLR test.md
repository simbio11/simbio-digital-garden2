...
> [!IMPORTANT]
> SLRT는 **민감도가 극히 높아 디스크 탈출증을 배제(Rule-out)하는 선별 검사로는 최적이지만, 햄스트링 단축이나 천장관절 문제로 인한 위양성이 흔해 단독 확진용으로는 특이도가 떨어집니다. 따라서 반드시 [[브라가드 검사]](특이도 약 85%) 및 교차 SLRT(특이도 약 95%)를 병합해야만 진단 정확도를 완성할 수 있습니다.
