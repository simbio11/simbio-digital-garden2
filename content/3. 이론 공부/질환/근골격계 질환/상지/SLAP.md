...
> [그림 1: 견관절 상부의 상완골두, 상부 관절와순, 상완이두근 장두건의 해부학적 부착 관계 및 SLAP 병변 발생 위치]
...
> [그림 2: 오버헤드 투구 동작의 말기 거상기(Late cocking phase). 견관절 외전·극대 외회전 시 상완이두근 장두건이 비틀리며 상부 관절와순을 뒤쪽에서부터 벗겨내는 필백(Peel-back) 역학 기전]
