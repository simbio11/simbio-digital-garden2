...
> - <font color="#fa7e7e">⚠️ 유의점: ACE 억제제는 브래디키닌 축적으로 인한 마른기침·혈관부종(angioedema) 부작용을 일으킬 수 있어 임상에서 주의 관찰이 필요.</font>
...
```mermaid
graph TD
    AngI["안지오텐신 I (10개 아미노산, 비활성)"] -->|ACE 절단 C-말단 His-Leu 제거| AngII["안지오텐신 II (8개 아미노산, 강력한 혈관수축물질)"]
    BK["브래디키닌 (혈관확장물질)"] -->|ACE Kininase II 활성| BKinactive["불활성 펩타이드 조각"]
    AngII --> Effect1["말초혈관 수축 → 혈압 상승"]
    AngII --> Effect2["부신피질 알도스테론 분비 자극 → Na+/수분 저류"]
```
...
* **ACE 유전자 다형성(I/D polymorphism)**: 삽입/결실(I/D) 다형성이 혈중 ACE 활성 및 일부 심혈관 질환 위험도와 연관된다는 연구가 있으나, 인과관계 및 임상적 활용도는 <font color="#fa7e7e">⚠️ 내용 검토 필요</font>(연구마다 결과가 상이).
...
일부 본초 유래 성분(예: 펩타이드류, 플라보노이드류)이 시험관 내(in vitro) 실험에서 ACE 저해 활성을 나타낸다는 연구들이 보고되어 있으나, 이는 대부분 초기 단계의 스크리닝 연구로 임상적 혈압강하 효과가 확립된 것은 아니므로 <font color="#fa7e7e">⚠️ 내용 검토 필요</font>로 표기합니다. 개별 본초와의 구체적 연계는 각 본초 노트에서 근거와 함께 별도로 확인이 필요합니다.
