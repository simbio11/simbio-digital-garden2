...
tags:
  ...
  - evidence-based
  - master-note
title: 01_음식을 씹을 때 한쪽 턱이 아파요_저작통_TMD
출처: PMID 19542799
---

# 🩺 [Clinical Master-Dive] "음식을 씹을 때 한쪽 턱이 아파요" — 저작통(咀嚼痛)의 감별과 측두하악장애(TMD) 통합 접근

> *"한쪽 어금니로 음식을 씹을 때마다 관자놀이·볼·턱관절 안쪽이 욱신거린다. 치과에 가도 '치아는 이상없다'는 말만 듣고 돌아온다." — 이 환자의 통증은 과연 치아에서 오는 것일까, 턱관절(관절원판)에서 오는 것일까, 아니면 씹는 근육(저작근)의 발통점(TrP)에서 오는 것일까? 오늘의 큐레이션은 비오님 볼트 `_의학/01_근골격계/근육/(1) 안면부/`의 출처 검증을 마친 저작근 4대 노트([[교근]], [[측두근]], [[내익상근]], [[외익상근]])를 축으로, `_의학/03_이론/질환/근골격계 질환/두경부/턱관절 통증`, `_의학/01_근골격계/신경/5. 삼차신경`, 강의록 [[턱관절에 대한 고찰]], 그리고 근이완·진경의 성방 [[작약감초탕]]을 하나의 '저작통 감별 지도' 위에서 만나게 한다.*
...
> 📌 볼트 `_의학/01_근골격계/이학적 검사/` 폴더에는 아직 TMJ 전용 검사 노트가 **없음(검토 필요 — 신규 노트 후보)**. 아래 검사 포인트는 질환 노트·근육 노트·강의록·임상례에서 발췌·통합한 것입니다.
...
- **_의학/01_근골격계/근육/(1) 안면부/**: [[교근]], [[측두근]], [[내익상근]], [[외익상근]] (출처검증 완료 — PMID 실측 2026-09-07)
- **_의학/01_근골격계/신경/**: [[5. 삼차신경|삼차신경]]
- **_의학/03_이론/질환/근골격계 질환/두경부/**: [[턱관절 통증]], [[두통]], [[거북목]], [[상부교차 증후군]]
- **_의학/03_이론/질환/신경계 질환/**: [[편두통]], [[경추성 두통]], [[안면신경마비]]
- **_지식/강의/3. 근골격계·추나·침구의학/**: [[턱관절에 대한 고찰]]
- **_첨부·자료/임상례/Case report/**: [[턱관절 한쪽만 열림]]
- **_의학/02_약리/처방/02_보익제/**: [[작약감초탕]]; **본초/**: [[백작약]], [[적작약]], [[감초]]; **약침/**: [[오공약침]]
- **_의학/00_기본의학/01. 레드플래그·응급 감별/**: (신규 후보 — '두경부·저작통 레드플래그' 노트 제안, 기존 [[2026-09-05_두통_중증감별]] 패턴 참고)

---

## 📚 근거·출처 (제1원칙 준수 — 가짜 출처 0건)

본 다이브의 인용·수치는 모두 비오님 볼트 노트에서 발췌했으며, 저작근 4종의 참고문헌은 **2026-09-07 출처검증 프로젝트**(`_AI/_클로드/작업기록/2026-09-07_근육_안면부_출처_검증_리포트.md`)에서 PubMed/EuropePMC 실측 완료된 것만 사용했습니다.
...
<!-- 보관 태그(1회용·링크오류, 필요시 복원): TMD, mastication-pain, trigeminal, trigger-point -->
