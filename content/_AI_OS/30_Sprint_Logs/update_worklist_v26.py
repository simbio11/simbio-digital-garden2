...
new_text = new_text.replace('정제판 v25', '정제판 v26')
new_text = new_text.replace('배치 1~58차 누적 완료', '배치 1~62차 누적 완료')

with open(list_path, 'w', encoding='utf-8') as f:
    f.write(new_text)

print(f"Updated worklist v26: Removed {removed_count} items ({', '.join(removed_names)}), {removed_refs} refs.")
