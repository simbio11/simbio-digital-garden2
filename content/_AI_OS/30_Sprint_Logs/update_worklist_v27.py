...
resolved_items = [
    "PGI2", "간문맥 고혈압", "GLP-1", "창부도담탕", "현부이경탕",
    "판상근", "대후두직근", "옥살산칼슘", "메틸유게놀", "안면신경마비",
    "하악골", "전자와", "대퇴사두건", "경골조면", "설골하근군", "근피신경 포착 증후군"
]
...
new_text = new_text.replace('정제판 v26', '정제판 v27')
new_text = new_text.replace('배치 1~62차 누적 완료', '배치 1~66차 누적 완료')

with open(list_path, 'w', encoding='utf-8') as f:
    f.write(new_text)

print(f"Updated worklist v27: Removed {removed_count} items ({', '.join(removed_names)}), {removed_refs} refs.")
